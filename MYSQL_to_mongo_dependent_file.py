...
# Step 1: Extract data from MySQL (batch fetch)
...
def save_to_mongo(**kwargs):
    ...
    print(f"Data insertion to MongoDB complete. Time taken: {time.time() - start_time:.2f} seconds")
...
with DAG(
    'mysql_to_mongo_pipeline_dependents',
    default_args=default_args,
    description='A pipeline to transfer dependents data from MySQL to MongoDB',
